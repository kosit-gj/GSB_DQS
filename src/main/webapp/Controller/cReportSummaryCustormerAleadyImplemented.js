	...
	   $.each(data,function(index,indexEntry){
		...
		     htmlTable+="<tr class='danger'>";
			      htmlTable+="<td>"+indexEntry['operation_name']+"</td>";
			      ...
			      htmlTable+="<td>"+indexEntry['cleansing']+"</td>";
			   	  htmlTable+="<td>"+indexEntry['mapping']+"</td>";
				  htmlTable+="<td>"+indexEntry['matching']+"</td>";
				  htmlTable+="<td>"+indexEntry['edit']+"</td>";
			      htmlTable+="<td>"+indexEntry['kpi']+"</td>";
			     ...
			     $.each(indexEntry['regions'],function(index2,indexEntry2){
			    	 htmlTable+="<tr class='warning'>";
						      htmlTable+="<td>-- "+indexEntry2['region_name']+"</td>";
						      htmlTable+="<td>ผลรวม</td>";
						      htmlTable+="<td>"+indexEntry2['cleansing']+"</td>";
						   	  htmlTable+="<td>"+indexEntry2['mapping']+"</td>";
							  htmlTable+="<td>"+indexEntry2['matching']+"</td>";
							  htmlTable+="<td>"+indexEntry2['edit']+"</td>";
						      htmlTable+="<td>"+indexEntry2['kpi']+"</td>";
					     ...
					     $.each(indexEntry2['districts'],function(index3,indexEntry3){
					    	 htmlTable+="<tr class='danger'>";
								      htmlTable+="<td>--- "+indexEntry3['district_name']+"</td>";
								      htmlTable+="<td>ผลรวม</td>";
								      htmlTable+="<td>"+indexEntry3['cleansing']+"</td>";
								   	  htmlTable+="<td>"+indexEntry3['mapping']+"</td>";
									  htmlTable+="<td>"+indexEntry3['matching']+"</td>";
									  htmlTable+="<td>"+indexEntry3['edit']+"</td>";
								      htmlTable+="<td>"+indexEntry3['kpi']+"</td>";
								     ...
								     $.each(indexEntry3['branches'],function(index4,indexEntry4){
								    	 htmlTable+="<tr class=''>";
											      htmlTable+="<td>---- "+indexEntry4['contact_branch_code']+"</td>";
											      ...
											      htmlTable+="<td>"+indexEntry4['cleansing']+"</td>";
											   	  htmlTable+="<td>"+indexEntry4['mapping']+"</td>";
												  htmlTable+="<td>"+indexEntry4['matching']+"</td>";
												  htmlTable+="<td>"+indexEntry4['edit']+"</td>";
											      htmlTable+="<td>"+indexEntry4['kpi']+"</td>";
...
var getDataFn = function() {
	...
	$.ajax({
		url:restfulURL+"/dqs_api/public/dqs_operation_report/progressed",
		type : "get",
		dataType : "json",
		data:{
...
$(document).ready(function(){
	...
	$("#exportToExcel").click(function(){
		...
		$("form#formExportToExcel ").attr("action",restfulURL+"/dqs_api/public/dqs_operation_report/progressed/export?token="+tokenID.token+""+param);
